...
namespace Zenject
{
    public class CheatSheet : Installer<CheatSheet>
    {
        ...
        public void InstallMore3()
        {
            ...
            Container.BindInstance(foo1)
                .When(c => c.ParentContexts.Where(x => x.MemberType == typeof(Bar) && Equals(x.Identifier, "Bar1"))
                    .Any());
            Container.BindInstance(foo2)
                .When(c => c.ParentContexts.Where(x => x.MemberType == typeof(Bar) && Equals(x.Identifier, "Bar2"))
                    .Any());
            ...
            Container.Bind(typeof(Foo), typeof(IBar), typeof(IFoo))
                .To<Foo>()
